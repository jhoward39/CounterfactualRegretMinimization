# TLDR: This is the training algorithm used to beat humans in texas hold em' (poker). It's a visualisation of it on a small scale using javascript, html, and css. Link broke, fixing within the month. 
